...
class OrderTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        order_detail_5 = OrderDetail.objects.create(product=product_2, quantity=15, order=order_3)
        order_detail_6 = OrderDetail.objects.create(product=product_3, quantity=20, order=order_3)
        order_detail_7 = OrderDetail.objects.create(product=product_1, quantity=20, order=order_3)
        order_detail_8 = OrderDetail.objects.create(product=product_4, quantity=2, order=order_3)

        order_4 = Order.objects.create(date_time=timezone.now())
        order_detail_9 = OrderDetail.objects.create(product=product_2, quantity=5, order=order_4)
